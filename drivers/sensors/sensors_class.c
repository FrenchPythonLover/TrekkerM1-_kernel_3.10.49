		...
		struct device_attribute *attr, char *buf)
{
	...
	return snprintf(buf, PAGE_SIZE, "MAG_TEST_X=%d,MAG_TEST_Y=%d,MAG_TEST_Z=%d,MAG_TEST_RS=%s\n",
				Show_test[0],Show_test[1],Show_test[2],Show_test[3]==1? "pass":"fail");
...
static struct device_attribute sensors_class_attrs[] = {
	__ATTR(name, 0440, sensors_name_show, NULL),
	__ATTR(vendor, 0440, sensors_vendor_show, NULL),
	__ATTR(version, 0440, sensors_version_show, NULL),
	__ATTR(handle, 0440, sensors_handle_show, NULL),
	__ATTR(type, 0440, sensors_type_show, NULL),
	__ATTR(max_range, 0440, sensors_max_range_show, NULL),
	__ATTR(resolution, 0440, sensors_resolution_show, NULL),
	__ATTR(sensor_power, 0440, sensors_power_show, NULL),
	__ATTR(min_delay, 0440, sensors_min_delay_show, NULL),
	__ATTR(fifo_reserved_event_count, 0440, sensors_fifo_event_show, NULL),
	__ATTR(fifo_max_event_count, 0440, sensors_fifo_max_show, NULL),
	__ATTR(max_delay, 0440, sensors_max_delay_show, NULL),
	__ATTR(flags, 0440, sensors_flags_show, NULL),
	__ATTR(enable, 0660, sensors_enable_show, sensors_enable_store),
	__ATTR(enable_wakeup, 0660, sensors_enable_wakeup_show,
			sensors_enable_wakeup_store),
	__ATTR(poll_delay, 0660, sensors_delay_show, sensors_delay_store),
	...
	__ATTR(calibrate, 0660, sensors_calibrate_show,
