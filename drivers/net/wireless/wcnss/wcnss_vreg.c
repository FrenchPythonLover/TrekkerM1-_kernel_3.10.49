...
/* Hisense: define wcnss_get_iris_id_names to read Wcnss_id @{ */
int wcnss_get_iris_id_name(char *iris_id_name)
{
	...
	switch (iris_id) {
	case WCN3660:
		memcpy(iris_id_name, "WCN3660", sizeof("WCN3660"));
		break;
	case WCN3660A:
		memcpy(iris_id_name, "WCN3660A", sizeof("WCN3660A"));
		break;
	case WCN3660B:
		memcpy(iris_id_name, "WCN3680B", sizeof("WCN3680B"));
		break;
	case WCN3620:
		memcpy(iris_id_name, "WCN3620", sizeof("WCN3620"));
		break;
	case WCN3620A:
		memcpy(iris_id_name, "WCN3620A", sizeof("WCN3620A"));
		break;
	case WCN3610:
		memcpy(iris_id_name, "WCN3610", sizeof("WCN3610"));
		break;
	case WCN3610V1:
		memcpy(iris_id_name, "WCN3615", sizeof("WCN3615"));
		break;
	case WCN3610TSMC:
		memcpy(iris_id_name, "WCN3615T", sizeof("WCN3615T"));
		break;
	default:
		return 1;
	}
...
EXPORT_SYMBOL(wcnss_get_iris_id_name);
/* @} */
