...
/* Hisense: precompile productinfo.h and proc_fs.h for productinfo node @{ */
...
/* Hisense: define the size of wlan_version and wlan_ftm for postel test @{ */
...
/* Hisense: add productinfo node @{ */
struct proc_dir_entry *proc_wlan_version;
char wlan_version[WLAN_VERSION_LEN];

/* define wlan_register_productinfo to register productinfo, and it can present the loaded state of wlan */
...
/* define wlan_version_show to show wlan_version */
...
/* define wlan_version_open to open wlan_version_show */
...
/* define init_wlan_proc to load wlan_version_open */
...
/* Hisense: add postel_test node @{ */
struct proc_dir_entry *proc_wlan_ftm;
char wlan_ftm[WLAN_FTM_LEN];

/* define wlan_ftm_show to show wlan_ftm */
...
/* define wlan_ftm_open to open wlan_ftm_show */
...
/* define init_wlan_ftm_proc to load wlan_ftm_open */
...
static int __init wcnss_wlan_init(void)
{
	...
	/* Hisense: load wlan_register_productinfo and init_wlan_proc when wlan init @{ */
	wlan_register_productinfo();
	init_wlan_proc();
	/* @} */

	/* Hisense: load init_wlan_ftm_proc when wlan init @{ */
	init_wlan_ftm_proc();
	/* @} */
