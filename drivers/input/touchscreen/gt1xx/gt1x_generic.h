...
#define GTP_KEY_TAB	 {KEY_BACK, KEY_HOMEPAGE, KEY_APPSELECT, KEY_MENU}
...
extern void gt1x_power_reset(bool need_power_onoff);
...
extern void gt1x_charger_config(int on);
