...
static struct ts_func_test_device *ts_func_test_device;
...
static ssize_t chip_detect_show(struct kobject  *obj, struct kobj_attribute *attr, char *buf)
{
	struct ts_func_test_device *test_device = ts_func_test_device;
	int ret = 0;
...
static ssize_t hall_show(struct kobject  *obj, struct kobj_attribute *attr, char *buf)
{
	struct ts_func_test_device *test_device = ts_func_test_device;
	bool enable = false;
...
static ssize_t hall_store(struct kobject  *obj, struct kobj_attribute *attr, const char *buf, size_t size)
{
	struct ts_func_test_device *test_device = ts_func_test_device;
...
static ssize_t glove_show(struct kobject  *obj, struct kobj_attribute *attr, char *buf)
{
	struct ts_func_test_device *test_device = ts_func_test_device;
	bool enable = false;
...
static ssize_t glove_store(struct kobject  *obj, struct kobj_attribute *attr, const char *buf, size_t size)
{
	struct ts_func_test_device *test_device = ts_func_test_device;
...
static ssize_t tptype_show(struct kobject  *obj, struct kobj_attribute *attr, char *buf)
{
	struct ts_func_test_device *test_device = ts_func_test_device;
	int enable = false;
...
static ssize_t tptype_store(struct kobject  *obj, struct kobj_attribute *attr, const char *buf, size_t size)
{
	struct ts_func_test_device *test_device = ts_func_test_device;
	...
	if (test_device && test_device->set_tptype_switch) {
		if (strncmp(buf, "0", 1)) {
			if (strncmp(buf, "1", 1)) {
				test_device->set_tptype_switch(test_device->dev, 2);
			} else {
				test_device->set_tptype_switch(test_device->dev, 1);
			}
		} else {
