 ...
 *
 */
#ifndef __LINUX_FOCALTECH_TS_H__
#define __LINUX_FOCALTECH_TS_H__
...
enum {
	GESTURE_OFF = 0, /* gesture function close */
	GESTURE_ON,  /* gesture function on */
};
