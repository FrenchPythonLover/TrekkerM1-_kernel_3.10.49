...
//add start,hmct
static long power_on_alarm_time;//hmct
long get_power_on_alarm_time(void)
{
	return power_on_alarm_time;
}
EXPORT_SYMBOL(get_power_on_alarm_time);
// add end
...
void set_power_on_alarm(long secs, bool enable)
{
	...
	power_on_alarm_time = alarm_time;////hmct
	/*
...
disable_alarm:
	printk("clr poweroff alarm\n");
	power_on_alarm = 0;
	power_on_alarm_time = 0;
...
void alarmtimer_shutdown(struct device *dev)
{
	set_power_on_alarm(power_on_alarm , 1);
}
...
static struct platform_driver alarmtimer_driver = {
	.driver = {
		.name = "alarmtimer",
		.shutdown = alarmtimer_shutdown,//hmct
